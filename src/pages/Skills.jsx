...
const Skills = () => {
  ...
  const skills = {
    frontend: [
      ...
      { name: 'React Native', level: 80, icon: <TbBrandReactNative className="text-[#61DAFB]" />, color: 'from-blue-400 to-purple-500' },
    ],
    backend: [
      { name: 'Node.js', level: 90, icon: <FaNodeJs className="text-[#339933]" />, color: 'from-green-500 to-emerald-400' },
      { name: 'Express.js', level: 88, icon: <SiExpress className="text-gray-100" />, color: 'from-gray-600 to-gray-300' },
      { name: 'GraphQL', level: 85, icon: <SiGraphql className="text-[#E535AB]" />, color: 'from-pink-600 to-purple-500' },
      { name: 'MongoDB', level: 87, icon: <SiMongodb className="text-[#47A248]" />, color: 'from-green-500 to-green-300' },
    ...
    devops: [
      ...
      { name: 'AWS', level: 82, icon: <FaAws className="text-[#FF9900]" />, color: 'from-amber-500 to-yellow-400' },
      { name: 'CI/CD', level: 88, icon: <FaCodeBranch className="text-[#F05032]" />, color: 'from-red-500 to-orange-400' },
      { name: 'Terraform', level: 75, icon: <SiTerraform className="text-[#7B42BC]" />, color: 'from-purple-500 to-indigo-400' },
    ],
    testing: [
      { name: 'Jest', level: 85, icon: <SiJest className="text-[#C21325]" />, color: 'from-red-600 to-red-400' },
      { name: 'Testing Library', level: 87, icon: <FaShieldAlt className="text-[#E535AB]" />, color: 'from-pink-500 to-purple-400' },
      { name: 'Cypress', level: 80, icon: <TbBrandCypress  />, color: 'from-gray-800 to-gray-600' },
      { name: 'Unit Testing', level: 90, icon: <FaCodeBranch className="text-[#4CAF50]" />, color: 'from-green-500 to-green-300' },
    ]
  };
