  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const response = await axios.get('https://yesanddone.com/');
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="text-blue-600 hover:text-blue-700 transition duration-300 flex items-center"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 hover:text-gray-700 transition duration-300 flex items-center"
                    >
